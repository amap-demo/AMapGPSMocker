...
@interface AGMFloatWindowRootVC ()

@end

@implementation AGMFloatWindowRootVC
...
- (AGMDragableView *)dragableView
{
    if (!_dragableView) {
        _dragableView = [[AGMDragableView alloc] init];
